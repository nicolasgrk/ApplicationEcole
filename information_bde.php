...
<?php
    ...
    if ($_GET['action'] == 'modifier') //Si l'action est égale a modifier on continue d'executer
        { 
            ...
            $req_pre = $cnx->prepare("SELECT * FROM bde WHERE id = :id");
                ...
                <div class="container">  
                    ...
                    <article class="columns is-centered">
                        <div class="column has-text-centered is-4">
                            <form method="post" action="information_bde_action.php?action=modifier" class="box"> <!--Formulaire pour modifier un joueur-->
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input class="input" type="date" name="newDate" id="date" value='<?php echo utf8_encode($info->dateEvenement); ?>' required> 
                                    </div>
                                </div>
...
?>
             <section class="section">
                <div class="container">               
                    <div class="columns is-centered">
                        <div class="column has-text-centered is-5">
                            <h1 class="title">Ajouter évenement</h1>    
                        </div>
                    </div>
                    <article class="columns is-centered">
                        <div class="column has-text-centered is-4">
                            <form method="post" action="information_bde_action.php?action=ajouter" enctype="multipart/form-data" class="box">
                                <div class="field">
...
?>
    <div class="columns is-centered">
        ...
        <div class="columns is-centered">
                <div class="column has-text-centered is-5">
                    <p>A partir de cette page, vous pouvez ajouter, modifier ou supprimer les evenements du bde. <a href="information_bde.php?action=nouveau">Ajouter un évenement</a> </p>
                </div>
        </div>
<?php
        ...
        include("include/_inc_parametres.php");
        include("include/_inc_connexion.php");
        $infoEcole=$cnx->query("SELECT * FROM bde "); //Récupération de toute la table note avec nom et prenom
...
?>
                <tr>
                    ...
                    <td><?php echo utf8_encode($prodInfo->dateEvenement); ?></td>
                    <td><a href='information_bde.php?action=modifier&id=<?php echo $prodInfo->id; ?>'><img src="https://img.icons8.com/color/30/000000/edit.png"></a></td><!--Icon pour modifier une ligne du tableau-->
                    <td><a href='information_bde_action.php?action=supprimer&id=<?php echo $prodInfo->id; ?>'><img src="https://img.icons8.com/color/30/000000/delete-sign.png"></a></td><!--Icon pour supprimer une ligne du tableau-->
                </tr>
 <?php 
